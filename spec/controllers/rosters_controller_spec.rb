  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved roster as @roster" do
        ...
        post :create, {:roster => { "name" => "invalid value" }}, valid_session
        assigns(:roster).should be_a_new(Roster)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested roster" do
        ...
        Roster.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => roster.to_param, :roster => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the roster as @roster" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Roster.any_instance.stub(:save).and_return(false)
        put :update, {:id => roster.to_param, :roster => { "name" => "invalid value" }}, valid_session
        assigns(:roster).should eq(roster)
      end
